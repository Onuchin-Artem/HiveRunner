...
public class HivePreparedStatement extends HiveRunnerStatement implements PreparedStatement {
    ...
    public HivePreparedStatement(HiveRunnerConnection connection, HiveServer.HiveServerHandler client,
                                 String sql) {
